...
const ProjectCard: React.FC<projectProps> = ({project}) => {
    return (
        <Paper elevation={3} sx={{marginBottom: '50px', padding: '40px'}} className="project-card">
            <Grid container spacing={5}>
                <Grid item md={6} xs={12} className="project-card__image">
                    <img src={project.imageSrc} alt={project.title} />
                </Grid>
                <Grid item md={6} xs={12} className="project-card__content">
